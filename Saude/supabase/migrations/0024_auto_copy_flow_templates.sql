-- =============================================
-- Migration 0024: Copy Flow Templates to New Tenant
--
-- Modifica a função create_new_tenant para copiar
-- automaticamente todos os fluxos que são templates (is_template = true)
-- para as novas contas de clientes.
-- =============================================
...
BEGIN
  ...
  SELECT 
    ...
    trigger_config,
    flow_data,
    false, -- Sempre inativo quando copiado para que o cliente ative após revisar
    false, -- A cópia na empresa do cliente não é um template global
    id     -- Referência ao template original
  FROM sp3_flows
